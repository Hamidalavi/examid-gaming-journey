...
>>>> D: My grip is normal fingertip grip in all types of games. **Slightly rotating my wrist to the right around the z axis**, then move the mouse to the right, so the ring and pinky fingers are allowed to touch and hold the mouse securely; **this makes horizontal aiming without skew or diagonal direction**. Then the thumb, ring and pinky fingers touch the mouse pad abit to avoid forcibly applying pressure to the mouse to create friction. Finally, **I move the thumb muscle closer to the mouse pad** (or rotate the wrist slightly to the left on the x-axis); now the mouse has enough space to move to the right and not touch the palm (mouse is floating between fingers); so the thumb finger can click every where of the mouse. Now I **DON'T** need to put my whole hand on the mouse so that my thumb reaches the side buttons of the mouse, which would cause friction and ruin my aiming. In this technique, I can be **fast and smooth** in aiming also on the normal cloth mouse pads
