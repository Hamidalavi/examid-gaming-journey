...
> [!WARNING]
**Basic aiming starts from the wrist for gripping the mouse straighly. The main goal is forearm for moving the mouse and it moves unconsciously**
...
16. Starts using **dynamic grip**; my grip is **feliform-like fingertip** grip with relaxed fingers in all types of games which is similar to the cheetah's digitigrade feet (walking on toes); then I lock the mouse clockwise rotation with the middle knuckle of the ring finger for the best accuracy, then move to the mouse to the right side (mouse right side alignment) and use fingetip as usual; now the pinky and ring fingers touch or hold the mouse securely and also thumb finger can click the side buttons easily. My main aiming is with the wrist and for the left area aiming, I don't pull my forearm or fingers back anymore, because I fixed the clockwise rotation and **it makes horizontal aiming without skew or diagonal direction** while aiming at left side with the wrist. Finally, I increased the grip height of my pinky and ring fingers so I could play fingertip style easier
...
9. Then I assumed that moving the mouse to the left side and parallel to the thumb finger for more horizontal acuracy, **but I was wrong**. It was an interesting trick, but the logic behind it was still unclear to me: **slow movement and fatigueless**
10. Then I realized that **the pivot point should be the elbow, not the forearm or wrist**, so I became a full arm player and I should aim with both wrist and forearm, then I simply pulled my forearm or fingers back for left area aiming with the wrist (better horizontal aiming): **extremely fast movement with more precision**
11. After using my both forarm and wrist, I realized that I should aim with my forarm and when I reach the enemy, aim with my wrist and use strafing technique so I can do micro adjustments easier without any wrist fatigue (perfect horizontal aiming): **extremely fast movement with perfect precision**
12. After every match, I stretched my fingers, wrists, forearms, shoulders, waist and legs to reset them. With this technique, even if my hands were in the air, they never get tired and I didn't get back pain: **extremely fast movement with tireless muscles**
...
14. In addition to the pinky, ring, and thumb fingers, **the index and middle fingers also applied a little pressure to the mouse** (pushing down) with the lowest tension, which has an amazing effect and my speed became like that of **The Flash** movie. Now the unclear logic of number 9 is clear, because **all fingers go a little higher and can push down a bit**. Fingers are like soldiers on alert, always in their places, never leaving their posts; now I can be fast and accurate with all grip styles and just have relax grip and finally having a perfect horizontal and vertical aim: **extremely fast movement with stable and not shaky aim**
15. Finally, I unlocked my secret aiming technique which switch between speed and accuracy by rotating fhe mouse in a clock style. I simply move the mouse to the right (right offset mouse alignment) and use the normal fingertip grip, then if I rotate the mouse counterclockwise, the mouse movement speed increases greatly, but the mouse accuracy (specially the horizontal movement) decreases. This means that the bottom of the mouse is far from the thumb muscle. If I turn the mouse clockwise, the mouse movement speed decreases, but the mouse accuracy increases and can do a horizontal movement with my wrist in a perfect line. This means that the bottom of the mouse is close to the thumb muscle, so I prefer to use between of these rotations (the middle one); sometimes I lock the mouse counterclockwise rotation with the middle knuckle of the ring finger for the best accuracy, but I don't pay attention too much for this lock, because when I rotating the mouse in a counterclockwise side, I feel the mouse bottom touches the ring and pinky fingers' first knuckles: **demon speed and supreme accuracy**
...
12. Compensate for analog sticks' friction by **clearing the dust and debris around the joysticks**. If you have a thumb muscle friction, you should adjust your wrist so that your thumb is flat on the controller; for example, place your thumb trough X and ∆ (A and Y), not O and ∆ (B and Y)
