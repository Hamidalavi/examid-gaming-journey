...
16. Starts using **dynamic grip**; my grip is **feliform-like fingertip** grip with relaxed fingers in all types of games which is similar to the cheetah's digitigrade feet (walking on toes); then move the mouse to the right side of hand or parallel to the pinky finger (right offset mouse alignment); now the pinky and ring fingers touch or hold the mouse securely and also thumb finger can click the side buttons easily. My main aiming is with wrist and for the left area aiming, I simply pull my forearm or fingers back, because **it makes horizontal aiming without skew or diagonal direction** while aiming at left side with the wrist. Finally, I increased the grip height of my pinky and ring fingers so I could play fingertip style easier
