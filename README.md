...
19. I could click on objects or items in most types of games, especially MMORPGs, without accidentally moving the game window by **rotating my wrist on the Y-axis while keeping the thumb muscle area close to the mouse pad**. I mean I was able to perform both **reactive** and **focused** clicks without moving the mouse by **clicking on the mouse buttons with center of fingertips** to having a precise click
20. While gaming on the keyboard, I pressed the keys with **center of the fingertip of each finger** and maintaining a compact grip. This prevented my pinky finger from getting fatigued and smoothed out the tension line between my hand and pinky finger. At the same time, my fingers were positioned far enough forward to hit every key effortlessly (no need to lift my hand at all); then I was rotating my wrist along the Y-axis to bring the fingers reach the keyboard keys
