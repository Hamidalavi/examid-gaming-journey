...
>>>> D: My pinky, ring and thumb fingers are **NOT** only positioned nearly parallel to the mousepad, they're **dynamic** in positioning. I also **DON'T** push my wrist or palm into the mouse (maybe abit touch), I just **USING** and **PUSHING** my fingertips down exactly like using controller or touch screen. By pushing your palm and wrist, your hand and wrist get fatigue faster over time and there's also a lot of friction, which can even cause the mouse skates and feet to wear out much faster which in turn will **greatly reduce** your aiming accuracy. BTW, I just use my fingertips (the end of the finger, slightly above the nail) to control the mouse
