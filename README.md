...
16. Starts using **dynamic hybrid grip** which is **feliform-like fingertip** grip with relaxed fingers in all types of games which is similar to the cheetah's digitigrade feet (walking on toes); then I move my pinky and ring fingers backward and my thumb forward to rotate the mouse. In this position, the left side of the mouse is slightly touching the thumb muscle, which means the mouse is aligned with the wrist. I mean the bottom of the mouse should be in line with my wrist, forearm and the elbow. Finally I increased the grip height of my pinky and ring fingers to push the mouse down a bit which allowed my speed and accuracy to reach the highest possible level without diagonal aiming
...
15. I move my pinky and ring fingers backward and my thumb forward to rotate the mouse. In this position, the left side of the mouse is slightly touching the thumb muscle, which means the mouse is aligned with the wrist: **demon speed without diagonal aiming**
