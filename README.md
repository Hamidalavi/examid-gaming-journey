...
19. I could click on objects or items in most types of games, especially MMORPGs, without accidentally moving the game window by **rotating my wrist on the Y-axis while keeping the thumb muscle area close to the mouse pad**. If you don't know how much to rotate your wrist, consider that the **top-left of metacarpal** (under the point finger) touches the mouse. I mean I was able to perform both **reactive** and **focused** clicks without moving the mouse by **clicking on the mouse buttons with center of fingertips** to having a precise click. That's why many players prefer to play with the claw grip. Although I'm a fingertip grip player and do this action with touching the top-left of metacarpal abit, that's it
20. While gaming on the keyboard, my fingers were positioned far enough forward to hit every key effortlessly (no need to lift my hand at all); then I was **rotating my wrist along the Y-axis and also having a floating wrist** to bring the fingers reach the keyboard keys. I still looking for the smoothing out the tension line between my hand and pinky finger
