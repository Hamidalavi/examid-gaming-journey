...
19. I could click on objects or items in most types of games, especially MMORPGs, without accidentally moving the game window by **keeping the wrist straight to the mouse pad** and simply straighten the fingers by touching the left side of the thumb finger to the mouse and hold it securely (even for pressing the side buttons), then push down the mouse into the mouse pad with the lowest tension
