...
16. Aim goes like a pro by moving the mouse to the right (level with the ring finger); so that the ring finger itself and pinky finger are allowed to push the mouse from the side, then push thumb easily for more accuracy. In addition, I curl my ring and abit pinky fingers to cover the mouse from side in a perfect position and comfortable grip
