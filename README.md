...
>>>> D: My grip is **feliform-like fingertip grip without too much curling my fingers** in all types of games with both two or three fingers above and each finger is used for one of these top three buttons which is similar to the cheetah's digitigrade feet (walking on toes); then move the mouse to the right side of hand or parallel to the pinky finger (right offset mouse alignment); now the pinky and ring fingers hold the mouse securely without pressure and also thumb finger can click the side buttons easily; **it's also makes horizontal aiming without skew or diagonal direction**
...
17. I raised the height of the table (or I lowered the height of the seat), then I opened my **armpits** since I bought a **SkyPAD Wallhack SP-004 Glass Gaming Mousepad** and became a **full arm** player; because I didn't want to raise my shoulders anymore, instead I did semi-float the arm on the table for more precision (not fully rest). I did full rest arm when I'm AFK or as a spectator mode. As a result, I played with the best speed and freedom of action and less arm friction while aming
...
19. I could click on objects or items in most types of games, especially MMORPGs, without accidentally moving the game window by **keeping the wrist straight to the mouse pad and having a tension management**; tighter grip for rapid clicking, then lighter grip for moving and aiming. That's why many players prefer to play with the claw grip (Although I still using the fingertip grip)
