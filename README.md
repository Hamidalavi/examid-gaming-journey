...
>>>> D: My grip is normal fingertip grip in all types of games. **Slightly rotating my wrist to the right around the z axis**, then move the mouse to the right (or buttom-left side of mouse touches the wrist if I use palm and claw grip). The ring and pinky fingers are touching the mouse to keep it secure; **this makes horizontal aiming without skew or diagonal direction**. Then the thumb, ring and pinky fingers touch the mouse pad abit to avoid forcibly applying pressure to the mouse to create friction. It's confusing at the first time and you think the thumb finger can't click the side buttons of the mouse with fingertip grip; but it can click them very easily by moving the thumb's muscle (not thumb finger itself) instead of fixed place; because there is an enough space between mouse and thumb muscle and this finger can click every where of the mouse. Now I **DON'T** need to put my whole hand on the mouse so that my thumb reaches the side buttons of the mouse, which would cause friction and ruin my aiming. In this technique, I can be **fast and smooth** in aiming also on the normal cloth mouse pads
...
> [!WARNING]
**The wrist rotation is based on the mouse rotate rate. For example, when I want to use Logitech G Pro Superlight Wireless mouse, I need to slightly rotate my wrist to the right for perfect horizontal aiming. You can test and draw lines in Microsoft Paint app**
