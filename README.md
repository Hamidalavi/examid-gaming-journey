...
> [!WARNING]
**Basic aiming starts from the fingers and the wrist rotation. The forearm is for the big movement and finally the elbow is for being a pivot point**
...
16. Starts using **dynamic hybrid grip** which is **feliform-like fingertip** grip with relaxed fingers in all types of games which is similar to the cheetah's digitigrade feet (walking on toes); then I move my pinky and ring fingertips backward and my thumbtip forward to rotate the mouse. In this position, the left side of the mouse is slightly touching the thumb muscle, which means the mouse is aligned with the wrist. I mean the bottom of the mouse should be in line with my wrist, forearm and the elbow. Finally I increased the grip height of my pinky and ring fingers to push the mouse down a bit (with fingertip) which allowed my speed and accuracy to reach the highest possible level without diagonal aiming
...
14. To do aiming and movement with confidence, I grip the mouse with relaxed fingers on the very top surface of the mouse which allowed my speed and accuracy to reach the highest possible level, and I was very happy to discover it: **demon speed with self-confidence accuracy**
15. I move my pinky and ring fingertips backward and my thumbtip forward to rotate the mouse. In this position, the left side of the mouse is slightly touching the thumb muscle, which means the mouse is aligned with the wrist: **demon speed without diagonal aiming**
