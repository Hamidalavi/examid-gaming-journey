...
16. Starts using **dynamic grip**; my grip is **feliform-like fingertip** grip without curling my fingers, **so straighten the fingers for speedy reactions** in all types of games which is similar to the cheetah's digitigrade feet (walking on toes); then move the mouse to the left side of hand or parallel to the thumb finger (left offset mouse alignment) or right-bottom side of the mouse reaches the wrist; now the pinky and ring fingers touch or hold the mouse securely and also thumb finger can click the side buttons easily; **it's also makes horizontal aiming without skew or diagonal direction**. Then I increased the grip height of my pinky and ring fingers so I could play fingertip style easier
...
9. Then I assumed that **moving the mouse to the left side and parallel to the thumb finger** for more speed and perfect horizontal aiming. It was an interesting trick, but the logic behind it was still unclear to me: **very fast movement and fatigueless**
