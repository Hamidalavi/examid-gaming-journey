...
16. Aim goes like a pro by moving the mouse to the right (level with the pinky finger); so that the ring and pinky fingers are allowed to push the mouse from the side, then push thumb easily for more accuracy
