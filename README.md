...
16. Starts using **dynamic hybrid grip** which is **feliform-like claw + fingertip** grip with relaxed and straight wrist and fingers in all types of games which is similar to the cheetah's digitigrade feet (walking on toes); it means that I click the mouse with the topmost part of the fingers (last knuckles) and stabilize the aim while clicking all mouse buttons (stop moving while clicking side or top buttons) with my index finger's metacarpal (soft pane area under index finger's knuckles) with straight wrist. **If the wrist is not straight**, I always need to forcibly move my pinky and ring fingertips backward and my thumbtip forward to rotate the mouse manually instead of auto adjustment and it also becomes harder to track enemies with wrist. In the correct position, the left side of the mouse is slightly touching to the thumb muscle which means the mouse is aligned with the wrist, forearm and elbow to perform a perfect aim (without diagonal movement). Finally I increased the grip height of my pinky and ring fingers to push the mouse down a bit (with fingertip) which allowed my speed and accuracy to reach the highest possible level with the lowest tension and I don't need a third-party app like **raw accel** for mouse rotation and acceleration for aiming
...
19. I could click on objects or items in most types of games, especially MMORPGs, without accidentally moving the game window by **keeping the wrist and thumb muscle straight to the mouse pad** and also use my index finger's metacarpal (soft pane area) for stabilizing the curser movement
...
15. Stabilize the aim while clicking all mouse buttons (stop moving while clicking side or top buttons) with my index finger's metacarpal (soft pane area under index finger's knuckles) with straight wrist position. **If the wrist is not straight**, I always need to forcibly move my pinky and ring fingertips backward and my thumbtip forward to rotate the mouse. In the correct position, the left side of the mouse is slightly touching the thumb muscle, which means the mouse is aligned with the wrist, forearm and elbow: **demon speed without diagonal aiming**
