...
16. Starts using **dynamic grip** which is **feliform-like fingertip** grip with relaxed fingers in all types of games which is similar to the cheetah's digitigrade feet (walking on toes); Then I increased the grip height of my pinky and ring fingers to push the mouse down a bit. Finally the bottom of the mouse should be in line with my wrist, forearm and the elbow without moving and rotating mouse adjustment, which allowed my speed and accuracy to reach the highest possible level without diagonal aiming
