...
9. I searched alot and I also updated everything and drivers one by one but the crashes not fixed. I decided fo change the network and display settings but it not helped me. I tried my last chance, which is to remove most of the drivers and programs that might be affecting the GPU and CPU as well as the RAM but the crashing still remains
...
12. After this perilous journey, the crashing problems were finally solved. In addition, the security and performance of the computer increased greatly. Even the appearance and UI of windows programs and settings changed and became similar to the Android version
