...
>>>> D: My grip is normal palm grip. The right side of metacarpal (under pinky finger) push the mouse from side to keep it secure. Then the thumb, ring and pinky fingers touch the mouse pad abit. It's confusing at the first time; but the thumb finger can click the side buttons very easily. Now I **DON'T** need to put my whole hand on the mouse so that my thumb reaches the side buttons of the mouse, which would cause friction and ruin my aiming. In this technique, I can be **fast and smooth** in aiming
