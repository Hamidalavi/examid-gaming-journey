...
16. Starts using **dynamic hybrid grip** which is **feliform-like claw + fingertip** grip with relaxed curled fingers in all types of games which is similar to the cheetah's digitigrade feet (walking on toes); it means that I click the topmost part of the mouse surface, because there is no need to apply pressure to the mouse to click and aim; then I move my pinky and ring fingertips backward and my thumbtip forward to rotate the mouse. In this position, the left side of the mouse is slightly touching the thumb muscle, which means the mouse is aligned with the wrist, forearm and elbow to perform a perfect aim (without diagonal movement). Finally I increased the grip height of my pinky and ring fingers to push the mouse down a bit (with fingertip) which allowed my speed and accuracy to reach the highest possible level without diagonal aiming and whenever I want to focus on enemies, I decrease the fingers' tension and just aim with index and middle fingers with the lowest pressure and tension
...
15. I move my pinky and ring fingertips backward and my thumbtip forward to rotate the mouse. In this position, the left side of the mouse is slightly touching the thumb muscle, which means the mouse is aligned with the wrist, forearm and elbow: **demon speed without diagonal aiming**
