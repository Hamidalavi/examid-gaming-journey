...
14. Finally, in addition to the pinky, ring, and thumb fingers, **the index and middle fingers also applied a little pressure to the mouse** (pushing down) with the lowest tension, which has an amazing effect and my speed became like that of **The Flash** movie. Now the unclear logic of number 9 is clear, because **all fingers go a little higher and can push down a bit**. Fingers are like soldiers on alert, always in their places, never leaving their posts; now I can be fast and accurate with all grip styles and just have relax grip and finally having a perfect horizontal and vertical aim: **demon speed and supreme accuracy**
