...
16. Starts using **dynamic hybrid grip** which is **feliform-like claw + fingertip** grip with relaxed and straight wrist and curled fingers in all types of games which is similar to the cheetah's digitigrade feet (walking on toes); it means that I click the mouse with the topmost part of the fingers and stabilize the aim while clicking all mouse buttons with **A. straighten the wrist, B. use middle of fingertips for top buttons, C. move the thumb fingertip upward while clicking the side buttons and D. increase the grip height of my pinky and ring fingers to push the mouse down a bit (with fingertip)** which allowed my speed and accuracy to reach the highest possible level with the lowest tension. **If the wrist is not straight**; it's becomes harder to track enemies. For the mouse correct rotating position, the left side of the mouse is slightly touching to the thumb muscle which means the mouse is aligned with the wrist, forearm and elbow to perform a perfect aim (without diagonal movement); so I don't need a third-party app like **raw accel** for mouse rotation and acceleration for aiming
...
19. I could click on objects or items in most types of games, especially MMORPGs, without accidentally moving the game window by **keeping the wrist straight to the mouse pad** and also use middle of fingertips for clicking the mouse top buttons. For stabilizing the aim while click, I simply push down the mouse into the mouse pad with my fingertips with the lowest tension
...
15. Stabilize the aim while clicking all mouse buttons (stop moving while clicking side or top buttons) with **A. straighten the wrist, B. use middle of fingertips for top buttons, C. move the thumb fingertip upward while clicking the side buttons and D. increase the grip height of my pinky and ring fingers to push the mouse down a bit (with fingertip)**. In the mouse correct rotating position, the left side of the mouse is slightly touching the thumb muscle, which means the mouse is aligned with the wrist, forearm and elbow: **demon speed without diagonal aiming**
