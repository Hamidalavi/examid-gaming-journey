...
> [!NOTE]
**Being a Pro**:
12. Make my mouse grip in my best comfortable situation; not using death grip with very high tension and also don't pushing the mouse down to the mouse pad with all fingers (except index and middle fingers). The side fingers have a wall-like pattern that prevents the mouse from slipping and their job is to lift the mouse and also stabilize the mouse, not press it (push the mouse down)
...
19. I could click on objects or items in most types of games, especially MMORPGs, without accidentally moving the game window by **keeping the wrist straight** and simply put the thumb muscle close to the mouse pad and **DON'T** push the mouse down into the mouse pad
...
15. Stabilize the aim while clicking all mouse buttons (stop moving while clicking side or top buttons) with **A. straighten the wrist and always put my thumb muscle close to the mouse pad; this technique would makes the fingers straight and hold the mouse securely, B. move the thumb fingertip upward while clicking the side buttons and I call this "omni clicking" and C. for smooth tracking, I DON'T push the mouse down to the mouse pad, I just use my index and middle fingers for aim and rotate the wrist with a lowest tension, other fingers help to lift up the mouse** which allowed my speed and accuracy to reach the highest possible level. **If the wrist is not straight**, it's becomes harder to track enemies, because the index and middle fingers lose their function which allowed my speed and accuracy to reach the highest possible level: **demon speed without diagonal aiming**
