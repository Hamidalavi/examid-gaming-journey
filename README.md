...
19. I could click on objects or items in most types of games, especially MMORPGs, without accidentally moving the game window by **keeping the wrist straight to the mouse pad**. Consider that the **top-center of metacarpal** (under the middle finger) touches the middle of the mouse. That's why many players prefer to play with the claw grip
