...
15. Pre-Lock enemies with **centering** (the crosshair should be on the enemy's chest or head) and **edge-locking** (aim at the edges of doors and windows. If I don't know where the enemy is, I aim for the middle of a door or window) and **not reseting** the mouse when focusing on enemies, then shoot them with **strafing technique** (move to the left or right instead of aiming left or right). When the enemy is close, **hipfire** is the best option for this. these methods will reduce the delay of aiming and firing significantly, just like the shooting delay between an SMG and an LMG
16. Starts using **dynamic grip**; my grip is **feliform-like fingertip** grip with relaxed fingers in all types of games which is similar to the cheetah's digitigrade feet (walking on toes); then move to the mouse to the right side (mouse right side alignment); now the pinky and ring knuckles hold the mouse securely and also thumb finger can click the side buttons easily. My main aiming is with just my fingers with the last knuckle of each of them, and my forearm is automatically pull back for the left area aiming. Finally, I increased the grip height of my pinky and ring fingers to push the mouse down a bit (e.g. as much as I'm clicking the mouse). I also applied pressure to my thumb, index and middle fingers for smooth aiming. Finally, to do aiming and movement with self-confidence, **I use the last knuckle of each finger and don't care about the position of the wrist, palm, or metacarpal**. This automatically adjusts the mouse clockwise/counterclockwise rotation, which allowed my speed and accuracy to reach the highest possible level, and I was very happy to discover it
...
19. I could click on objects or items in most types of games, especially MMORPGs, without accidentally moving the game window by **keeping the wrist and thumb muscle straight to the mouse pad (the wrist rotates along the Y-axis) and having a tension management**; tighter grip for rapid clicking, then lighter grip for moving and aiming
20. While gaming on the keyboard, my fingers were positioned far enough forward to hit every key effortlessly (no need to lift my hand at all and I just ran my hand across the table); instead of my forearm, I used my elbow as the pivot point, which made my hand angle 90 degrees and made it much easier to press the keyboard keys. Then I was **rotating my wrist along the Y-axis and also having a floating wrist** to bring the fingers reach the keyboard keys. I still looking for the smoothing out the tension line between my hand and pinky finger
...
6. Changed my grip to fingertip style and I said **I have a fastest movement**, but how it's happened? The short answer is **the hand and palm are not rest on the mouse anymore** and I felt light when aiming; then moved the mouse into right side (parallel to the pinky finger) and my aiming movement gots more speed, but the horizontal movement with the wrist had become very terrible: **fast movement with wrong direction**
...
9. Then I assumed that moving the mouse to the left side and parallel to the thumb finger for more horizontal accuracy, **but I was wrong**. It was an interesting trick, but the logic behind it was still unclear to me: **slow movement and fatigueless**
10. Then I realized that **the pivot point should be the elbow, not the forearm or wrist**, so I became a full arm player and **I should aim with just my fingers for vertical and horizontal side, not the wrist and forearm**; so my forearm pulled back automatically for 5he left area aiming with the wrist (better horizontal aiming): **extremely fast movement with more precision**
...
13. After a year, I realized something: I never put my index and middle fingers on the mouse, and I only used them when clicking. **These two fingers can be very useful for accuracy and speed**, and I had been oblivious to it for all this time. Additionally, I didn't worry about wrist and forearm rotation in the y-axis anymore and the hand always moved in a straight direction: **extremely fast movement with significant improvement**
14. In addition to the pinky, ring, and thumb fingers, **the index and middle fingers also applied a little pressure to the mouse** (pushing down) with the tension management, which has an amazing effect and my speed became like that of **The Flash** movie. Now the unclear logic of number 9 is clear, because **all fingers went a little higher and could push down a bit and when I reached the enemy, I lowered my fingers' tension and just applied pressure to my index and middle fingers for smooth aiming. Fingers are like soldiers on alert, always in their places, never leaving their posts; now I can be fast and accurate with all grip styles and just have relax grip and finally having a perfect horizontal and vertical aim: **extremely fast movement with stable and not shaky aim**
15. I unlocked my secret aiming technique which switch between speed and accuracy by rotating fhe mouse in a clock style. If I rotate the mouse counterclockwise, the mouse movement speed increases greatly, but the mouse accuracy (specially the horizontal movement) decreases. This means that the bottom of the mouse is far from the thumb muscle. If I turn the mouse clockwise, the mouse movement speed decreases, but the mouse accuracy increases and can do a horizontal movement with my wrist in a perfect line. This means that the bottom of the mouse is close to the thumb muscle, so I prefer to use between of these rotations (the middle one): **demon speed but without self-confidence accuracy**
16. To do aiming and movement with confidence, I use the last knuckle of each finger and don't care about the position of the wrist, palm, or metacarpal. This automatically adjusts the mouse clockwise/counterclockwise rotation, which allowed my speed and accuracy to reach the highest possible level, and I was very happy to discover it: **demon speed with self-confidence accuracy**
...
> [!WARNING]
**If you try to push the thumb in wrong way to aim, you will encounter slight friction that will cause your aim to be distorted or you will feel like the controller is broken

13. After lots of research, I finally figured out how to use thumbsticks for movement and aim. Just like the **KBM** journey, I tested over 200 grips and got nowhere. Then I have come to the conclusion that **turning and bending the wrist has no effect on the aiming and movement process. Only the area around the tip of the thumb decides which part of it is touched**. For example, if I hold the **Nacon Revolution 5 Pro** controller in my hand and wrap my fingers around the controller (to click all four backpaddles), the right part of the tip of the thumb is used for the joystick. As I said about the mouse grip journey above (number 12), the fingers are like soldiers on alert, never leaving their posts; just put the fingers on buttons (or back paddles) and joystick with moderate tension**. I don't have to do anything with the wrists, palms, or metacarpals anymore, the fingertips (the last knuckles) do all the proces

> [!WARNING]
**Depending on the size and type of controller, you should test it yourself and make sure that both horizontal and vertical movements in both thumbsticks are easy to move**
